 ...
 */
 ...
 var completePerson = buildPerson(plainPerson, 'Jack', 99);
...
function detectingTransmission(object){
  if(object.automaticTransmission === true){
    console.log('Automatic transmissions suck!');
  }else{
    console.log('Manual transmission FTW!');
  }
  return object;
}
